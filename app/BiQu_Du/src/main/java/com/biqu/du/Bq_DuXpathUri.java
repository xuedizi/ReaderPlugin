...
public class Bq_DuXpathUri {
  ...
  //匹配小说结果列表
  public static final String Xpath_Search_Item = "//div[@class='item']";
  //匹配小说结果小说名称
  public static final String Xpath_Search_Name = "dl/dt/a/text()";
  //匹配小说结果小说地址
  public static final String Xpath_Search_Path = "dl/dt/a/@href";
  //匹配小说结果小说logo
  public static final String Xpath_Search_Logo = "div[@class='image']/a/img/@src";
  //匹配小说结果小说作者
  public static final String Xpath_Search_Author = "dl/dt/span/text()";
  //匹配小说结果小说介绍
  public static final String Xpath_Search_Intro = "dl/dd/text()";
  //小说书名
  ...
  //小说简介
  public static final String Xpath_novel_introduction = "//div[@id='intro']/text()";
  //小说更新时间
  public static final String Xpath_novel_last_modified="//div[@id='info']/p[3]/text()";
  //搜索结果标题列表
  public static final String Xpath_Novel_Search_Title_List = "//div[@class='image']/a/img/@alt";
  //搜索结果链接列表
  public static final String Xpath_Novel_Search_Url_List = "//div[@class='image']/a/@href";
  //导航地址列表
  ...
  //导航小说条目内容
  public static final String Xpath_Navigate_Novel_Item = "//div[@id='hotcontent']/div/div";
  //最近更新的小说列表
  ...
  //最近更新小说作者
  public static final String Xpath_Navigate_Laster_Update_Novel_Author = "span[@class='s4']/text()";
  //最近更新小说最新章节
